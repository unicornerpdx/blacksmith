class AwsJob
  ...
  def perform(data)
    ...
    begin
      ...
      AWS.config access_key_id: job.aws_region.aws_account.access_key, secret_access_key: job.aws_region.aws_account.secret_key, region: job.aws_region.region
      ec2 = AWS.ec2

      ssh_config = "###############################################
  ## AWS Account: #{job.aws_region.aws_account.name}
